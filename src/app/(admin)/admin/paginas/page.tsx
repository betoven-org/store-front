                ...
                >
                  <td className="px-4 py-3 font-medium text-foreground">
                    <span className="flex items-center gap-2">
                      {dp.title}
                      <span className="rounded bg-accent px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">dinamica</span>
                    </span>
                  </td>
                  <td className="px-4 py-3 text-muted-foreground">
                    <code className="rounded bg-accent px-1.5 py-0.5 text-xs">{dp.slug}</code>
                  </td>
                  ...
                  <td className="px-4 py-3 text-muted-foreground">
                    {new Date(dp.updatedAt).toLocaleDateString("pt-BR", {
